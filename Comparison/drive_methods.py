...
def drive(component):
	...
	if component == "azimuth":
		...
		file1 = "Results/Results_Hammond/dilatation.nc"
		file2 = "Results/Results_Numpy_Spline/dilatation.nc"
		file3 = "Results/Results_Visr/dilatation.nc"
		file4 = "Results/Results_ND_interp/dilatation.nc"
		file5 = "Results/Results_Tape/dilatation.nc"
