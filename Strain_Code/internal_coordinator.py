...
compute_dict = {
    ...
    "delaunay_flat": strain_delaunay_flatearth.compute_test,
    "gpsgridder": strain_gpsgridder.compute,
    "visr": strain_visr.compute };


def strain_coordinator(MyParams):
    # For testing the old format with delaunay:
    # [xcentroid, ycentroid, triangle_vertices, rot, e1, e2, v00, v01, v10, v11] = compute_dict[MyParams.strain_method](0, MyParams);

    #  For after the test is resolved.
