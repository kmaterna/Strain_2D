...
def compute_with_delaunay_polygons(myVelfield):
    ...
    for i in range(trishape[0]):
        ...
        [exx_triangle, exy_triangle, eyy_triangle, rotation_triangle] = strain_tensor_toolbox.compute_strain_components_from_dx(dVEdE, dVNdE, dVEdN, dVNdN);
